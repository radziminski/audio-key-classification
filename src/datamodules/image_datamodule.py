...
class ImageDataModule(GenericDatamodule):
    ...
    def _prepare_data(self):
        ...
        download_and_unzip(
            self.hparams.ncs_images_url,
            os.path.join(self.hparams.images_dir, "ncs_images.tar.xz"),
            self.hparams.images_dir,
            "url",
        )
        download_and_unzip(
            self.hparams.gs_mtg_images_url,
            os.path.join(self.hparams.images_dir, "gs_mtg.tar.xz"),
            self.hparams.images_dir,
            "url",
        )
        download_and_unzip(
            self.hparams.gs_key_images_url,
            os.path.join(self.hparams.images_dir, "gs_key.tar.xz"),
            self.hparams.images_dir,
            "url",
        )
